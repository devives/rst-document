...
public interface AdmonitionBuilder<PARENT extends RstNodeBuilder<?, ?, ?, ?>>
        extends RstNodeBuilder<PARENT, RstElement, Admonition, AdmonitionBuilder<PARENT>>,
        BodyBuilders<PARENT, RstElement, Admonition, AdmonitionBuilder<PARENT>> {
