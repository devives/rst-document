...
public interface CodeBuilder<PARENT extends RstNodeBuilder<?, ?, ?, ?>>
        extends InlineBuilders<PARENT, RstElement, Directive, CodeBuilder<PARENT>> {

    String LANGUAGE_UNKNOWN = "";
    String LANGUAGE_PYTHON = "python";
    String LANGUAGE_C = "c";

    CodeBuilder<PARENT> setLanguage(String language);

    CodeBuilder<PARENT> setNumberLines(boolean numberLines);
