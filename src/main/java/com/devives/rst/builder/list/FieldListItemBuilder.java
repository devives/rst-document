...
public interface FieldListItemBuilder<PARENT extends RstNodeBuilder<?, ?, ?, ?>>
        extends BodyBuilders<PARENT, RstElement, FieldListItem, FieldListItemBuilder<PARENT>> {

    FieldListItemBuilder<PARENT> setName(String name);
}