...
public interface LineBlockItemBuilder<PARENT extends RstNodeBuilder<?, ?, ?, ?>>
        extends InlineBuilders<PARENT, InlineElement, LineBlockItem, LineBlockItemBuilder<PARENT>> {
