...
public class Paragraph extends RstNodeAbst<InlineElement> {

    @Override
    public String serialize() throws RstSerializationException {
        String text = super.serialize();
        String aligned = StringUtils.alignLeftEdge(text);
        return aligned + NL; // Always appending new line at the end.
    }
}
